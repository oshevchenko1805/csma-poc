...
def fig_tradeoff(rows: list, outdir: str) -> None:
    ...
    ax.set_title("Стримування купується координацією, і розмір плати задає "
                 "дія відновлення, а не сама архітектура", pad=12)
    S.despine(ax)
    ...
    ax.text(0, -0.30,
            ...
            transform=ax.transAxes, fontsize=7.6, color=S.MUTED,
